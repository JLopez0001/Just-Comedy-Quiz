...
const shaneGillisData = {
    ...
    characteristics: ["dark", "edgy", "controversial", "political", "self-deprecating", "slapstick", "crowd work", "LGBTQ+"],
    specials: ["Beautiful Dogs", "Shane Gillis Live in Austin"],
    notable_works: ["Matt and Shane's Secret Podcast", "Gilly and Keeves", "Comedy Central Presents: Shane Gillis", "The Anthony Cumia Show", "Kill Tony","The Bonfire with Big Jay Oakerson and Dan Soder", "The Joe Rogan Experience", "Flagrant"],
...
const andrewSchulzData = {
    ...
    characteristics: ["dark", "edgy", "controversial", "political", "self-deprecating", "crowd work", "LGBTQ+", "stand-up"],
    specials: ["Infamous", "Schulz Saves America", "The Crowd Work Special","Views from the Cis", "4:4:1"],
    notable_works: ["You People", "Guy Code", "White Men Can't Jump","The Brilliant Idiots", "Flagrant 2", "The Joe Rogan Experience","Kill Tony", "The Breakfast Club", "Bad Friends", "This Past Weekend"],
...
const daveChappelleData = {
    ...
    characteristics: ["dark", "edgy", "controversial", "political", "crowd work", "LGBTQ+"],
    specials: ["The Bird Revelation", "Sticks & Stones", "The Closer", "Killin' Them Softly", "Deep In the Heart of Texas", "Equanimity"],
    notable_works: ["The Oscars", "Chappelle's Show", "Half Baked", "The Nutty Professor", "The Joe Rogan Experience", "The Breakfast Club", "Saturday Night Live"],
...
const msPatData = {
    ...
    gender: "Female",
    comedy_styles: ["sketch", "dark"],
    characteristics: ["dark", "edgy", "controversial", "crowd work"],
...
const whitneyCummingsData = {
    ...
    gender: "Female",
    comedy_styles: ["sketch", "dark"],
    characteristics: ["dark", "edgy", "controversial", "crowd work", "LGBTQ+", "political"],
    specials: ["Mouthy", "Roast of Whitney Cummings", "Jokes", "Can I Touch It?", "I'm Your Girlfriend"],
    notable_works: ["I'M FINE... AND OTHER LIES", "Whitney","The Wendy Williams Show", "Funny You Should Ask", "Kill Tony", "Good For You Podcast with Whitney Cummings", "2 Broke Girls","The Joe Rogan Experience", "This Bitch Podcast", "Flagrant 2", "Jimmy Kimmel Live", "The Joe Rogan Experience"],
...
const jessicaKirsonData = {
    name: "Jessica Kirson",
    gender: "Female",
    comedy_styles: ["self-deprecating", "slap-stick", "dark"],
    characteristics: ["LGBTQ-friendly", "dark", "self-deprecating", "slapstick", "crowd work", "LGBTQ+", "stand-up"],
...
const matteoLaneData = {
    name: "Matteo Lane",
    gender: "Male",
    comedy_styles: ["crowd work", "observational"],
    characteristics: ["LGBTQ-friendly", "crowd work", "LGBTQ+", "stand-up", "observational", "musical", "impressions"],
    specials: ["Matteo Lane: The Advice Special", "Matteo Lane: Hair Plugs & Heartache", "Matteo Lane: The Advice Special Part Two"],
    notable_works: ["The Comedy Lineup", "The Late Show with Stephen Colbert", "Flagrant",  "We Might Be Drunk Podcast", "Your Mom's House"],
...
const gabrielIglesiasData = {
    ...
    characteristics: ["clean", "story telling"],
    ...
    notable_works: ["Mr. Iglesias", "Magic Mike XXL", "The Nut Job", "The Fluffy Movie","Space Jam: A New Legacy", "The Joe Rogan Experience"],
...
const joKoyData = {
    ...
    gender: "Male",
    comedy_styles: ["clean"],
    characteristics: ["clean", "story telling", "diversity"],
    specials: ["Live from the LA Forum", "In His Elements", "Comin' in Hot", "Live from Seattle", "Lights Out", "Don't Make Him Angry"],
    notable_works: ["Easter Sunday", "The Monkey King", "Flagrant", "Your Mom's House", "This Past Weekend"],
...
const aliSiddiqData = {
    ...
    characteristics: ["dark", "edgy", "controversial", "story telling", "observational"],
    specials: ["The Domino Effect", "The Domino Effect 2", "It's Bigger Than These Bars"],
    notable_works: ["The Joe Rogan Experience", "Kill Tony", "Are You Garbage?"],
...
const burtKreischerData = {
    name: "Burt Kreischer",
    gender: "Male",
    comedy_styles: [ "story telling", "observational", "dark"],
    characteristics: ["dark", "edgy", "controversial", "story telling", "observational", "self-deprecating"],
    specials: ["Razzle Dazzle", "Hey Big Boy", "Secret Time", "The Machine", "Comfortably Dumb"],
    notable_works: ["The Machine", "The Cabin with Bert Kreischer", "Bert the Conqueror", "2 Bears 1 Cave", "Bertcast", "The Joe Rogan Experience", "Kill Tony", "This Is Not Happening"],
...
const tomSeguraData = {
    ...
    notable_works: ["Comedy Central Presents","I'd Like to Play Alone, Please","Your Mom's House", "2 Bears 1 Cave", "The Joe Rogan Experience", "Kill Tony"],
...
const kevinHartData = {
    name: "Kevin Hart",
    gender: "Male",
    comedy_styles: ["clean", "high comedy", "dark"],
    characteristics: ["edgy", "story telling", "observational", "self-deprecating"],
...
const jeffDunhamData = {
    name: "Jeff Dunham",
    gender: "Male",
    comedy_styles: ["ventriloquism", "dark"],
    characteristics: ["dark", "edgy", "controversial", "observational"],
