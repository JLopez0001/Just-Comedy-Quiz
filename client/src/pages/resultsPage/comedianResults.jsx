...
const ResultsPage = () => {
  ...
  const handleCardClick = (comedianName, comedianID) => {
    navigate(
      `/comedians/info/${comedianName.replace(/\s+/g, "-")}/${comedianID}`
    );
  };
              ...
              return (
                ...
                >
                  <Card sx={{ maxWidth: 345 }}>
                    <CardActionArea
                      onClick={() =>
                        handleCardClick(comedian.name, comedian._id)
                      }
                      sx={{
                        "&:hover": {
                    ...
                    >
                      ...
                      <CardActions>
                        <Button
                          ...
                          size="small"
                          color="primary"
                          href={`/comedians/info/${comedian.name.replace(
                            /\s+/g,
                            "-"
                          )}/${comedian._id}`}
                        >
